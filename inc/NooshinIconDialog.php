 ...
 */
?>
<div id="dialog1" title="انتخاب آیکون" hidden="hidden">
    <div id="tab1" title="tab1">
        <ul>
            <li><a href="#a">گروه1</a></li>
            <li><a href="#b">گروه2</a></li>
            <li><a href="#c">گروه3</a></li>
            <li><a href="#d">گروه4</a></li>
        </ul>
        <div id="a"><i class="fa fa-ad"></i>
        ...
        <div id="b"><i class="fa fa-chevron-circle-down"></i>
